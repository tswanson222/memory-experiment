...
This shows the fixed effect estimates for each predictor, as well as the confidence intervals in the table below (I'll combine these into a single plot; it appears that I have to update my version of R to do so).
